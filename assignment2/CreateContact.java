...
public class CreateContact {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.xpath("//input[@id='firstNameField']")).sendKeys("nelson");
		driver.findElement(By.xpath("//input[@id='lastNameField']")).sendKeys("mano");
		...
		driver.findElement(By.xpath("//input[@id='createContactForm_primaryEmail']")).sendKeys("nelson08mn@gmail.com");
